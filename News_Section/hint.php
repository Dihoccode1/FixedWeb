...
<head>
  ...
  <title>Gợi ý loại sáp vuốt tóc nam nên thử một lần trong đời</title>
...
<section class="bread-crumb">
  <div class="container">
    <ul class="breadcrumb">
      ...
      <li><strong><span>Gợi ý loại sáp vuốt tóc nam nên dùng thử</span></strong></li>
    </ul>
  </div>
</section>
    ...
    <div class="col-12 col-lg-8 col-70 content-pad mb-3">
      <div class="container-section">
        ...
        <div class="rte">
          ...
          <p><img src="../assets/images/dung1lan.jpg" alt="Gợi ý sáp vuốt tóc nam tốt nhất nên dùng thử một lần trong đời"></p>
        ...
        <div class="prevnext">
          <div>← <a href="../News_Section/maintenance.php">Bài viết trước</a></div>
          <div><a href="../News_Section/maintenance.php">Bài viết sau</a> →</div>
        </div>
