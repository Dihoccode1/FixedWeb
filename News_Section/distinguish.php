...
<head>
  ...
  <style>
    ...
    /* Giữ link sidebar là màu đen (nếu dùng module content.php) */
    .left-content .blog-aside a,
    .left-content .blog-aside a:visited{color:#111!important;text-decoration:none}
    .left-content .blog-aside a:hover{color:#000!important;text-decoration:underline}
    .left-content .aside-title .title-head a{color:#111!important;text-decoration:none}
...
<section class="bread-crumb">
  <div class="container">
    <ul class="breadcrumb">
      ...
      <li><strong><span>Cách phân biệt sáp vuốt tóc thật và giả</span></strong></li>
    </ul>
  </div>
</section>
...
.sidebar-box { width:100%; padding:0 20px; }

/* Item trong sidebar gọn gàng */
.sidebar-box .loop-blog { padding:12px 0; border-bottom:1px dashed #e9e9e9; }
.sidebar-box .loop-blog:last-child { border-bottom:none; }
.sidebar-box .name-right h3 { font-size:16px; line-height:1.4; margin:0 0 6px; }
.sidebar-box .date { font-size:13px; color:#999; }

/* Banner responsive + khoảng cách */
.banner_blogs .widget { margin-top:16px; }
.banner_blogs img { max-width:100%; height:auto; display:block; border-radius:6px; }

@media (min-width: 992px){
  .sidebar-box { padding:0 24px; } /* nhích “sang 1 xíu” cho thoáng ở desktop */
}
</style>
    ...
    <div class="col-12 col-lg-8 col-70 content-pad mb-3">
      <div class="container-section">
        <h1 class="article-title">
          <a href="#">Cách phân biệt sáp vuốt tóc thật và giả</a>
        </h1>
        <div class="meta">
        ...
        <div class="rte">
          ...
          <p><img src="../assets/images/phan_biet.jpg" alt="Cách phân biệt sáp vuốt tóc thật và giả"></p>
        ...
        <div class="prevnext">
          <div>← <a href="../News_Section/hint.php">Bài viết trước</a></div>
          <div><a href="../News_Section/gold_digger.php">Bài viết sau</a> →</div>
        </div>
