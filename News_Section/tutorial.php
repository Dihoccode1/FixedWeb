...
<head>
  ...
  <title>Hướng dẫn sử dụng sáp vuốt tóc đúng cách</title>
  ...
  <link rel="stylesheet" href="../News_Section/style.css"><!-- sidebar dùng css này (tạm encode khoảng trắng) -->
...
<section class="bread-crumb">
  <div class="container">
    <ul class="breadcrumb">
      ...
      <li><strong><span>Hướng dẫn sử dụng sáp vuốt tóc đúng cách</span></strong></li>
    </ul>
  </div>
</section>
  ...
  <div class="row">
    ...
    <div class="col-12 col-lg-4 col-30 sidebar-pad">
      <style>
        ...
        @media (min-width: 992px){ .sidebar-box { padding:0 24px; } }
      </style>
    ...
    <div class="col-12 col-lg-8 col-70 content-pad mb-3">
      <div class="container-section">
        ...
        <div class="rte">
          ...
          <p><img src="../assets/images/huong_dan.jpg"Hướng dẫn sử dụng sáp vuốt tóc đúng cách></p>
        </div>

       

        <div class="prevnext">
          <div>← <a href="../News_Section/gold_digger.php">Bài viết trước</a></div>
          <div><a href="../News_Section/hint.php">Bài viết sau</a> →</div>
        </div>
        ...
        <div class="comment">
          <div class="avatar"><img src="../assets/images/cm1.png" alt="avatar"></div>
          <div class="c-body">
        ...
        <div class="comment">
          <div class="avatar"><img src="../assets/images/cm2.png" alt="avatar"></div>
          <div class="c-body">
