...
<html lang="vi">
  <head>
    ...
    <title>Quản lý sản phẩm | Nobility 1800s Admin</title>
  ...
  <body>
    <div class="container">
      <div class="navagation">
        <ul>
          ...
          <li class="hovered" id="nav-products">
            <a href="./products.php">
    ...
    <div class="main">
      <div class="page">
        ...
        <!-- Toolbar: Search + Filters (responsive row layout) -->
        <div class="products-toolbar">
          ...
          />
          <select id="filter-cat" class="input products-filter-cat" >
            <option value="">— Tất cả loại —</option>
          </select>
          <select id="filter-status" class="input products-filter-status" >
        ...
        <div class="details">
          <!-- Products Table Section - Full Width Scoped -->
          <div class="products-table-section">
            <div class="recentOrders inline-clean-10" >
              <div class="cardHeader"><h2>Danh sách sản phẩm</h2></div>
              <table class="products-table">
                <thead>
                  <tr>
                    <td class="col-id">#</td>
                    <td class="col-thumb">Hình</td>
                    <td class="col-code">Mã</td>
                    <td class="col-name">Tên</td>
                    <td class="col-cat">Loại</td>
                    <td class="col-unit">ĐVT</td>
                    <td class="col-qty">SL</td>
                    <td class="col-cost">Giá vốn</td>
                    <td class="col-markup">%LN</td>
                    <td class="col-price">Giá đề xuất</td>
                    <td class="col-supplier">Nhà cung cấp</td>
                    <td class="col-status">Hiện trạng</td>
      ...
      <aside id="prod-drawer" class="drawer" aria-hidden="true">
        <div class="cardHeader">
          <h2 id="form-title"  class="inline-clean-12">Thêm sản phẩm</h2>
        ...
        <div class="drawer-body form-col">
          <form id="prod-form">
            ...
            <input
              ...
              type="text"
              required
              placeholder="Apestomen Nitro"
            />

            <label class="small">Loại</label>
            <select id="categoryId" name="category_id" class="input" required></select>

            <label class="small">Mô tả</label>
            <input id="desc" name="description" class="input" type="text" placeholder="Mô tả..." />

            <label class="small">Đơn vị tính</label>
            <input
              id="uom"
              name="unit"
              class="input"
            ...
            <label class="small">Tỉ lệ lợi nhuận mong muốn (%)</label>
            <input id="margin" name="profit_margin" class="input" type="number" min="0" value="0" />

            <label class="small">Nhà cung cấp</label>
            <input
              id="supplier"
              name="supplier"
              class="input"
            ...
            <label class="small">Hiện trạng</label>
            ...
            <input id="image" name="image" class="input" type="file" accept="image/*" />
            <div id="img-preview"  class="inline-clean-33"></div>

            <div
              
             class="inline-clean-13">
    ...
    <!-- Seed sản phẩm của User (phải load TRƯỚC products.js) -->
    ...
    <script>
      ...
      // Cho products.js mở form khi click "Sửa"
      window.AdminProductDrawer = { open: openDrawer, close: closeDrawer };
    </script>
  </body>
</html>
