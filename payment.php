    ...
    <script>
      (function () {
        ...
        if (!user) {
          ...
          var accountPath = <?php echo json_encode(app_rel_url('account/login.php')); ?>;
          location.href = accountPath + "?redirect=" + encodeURIComponent(back);
          return; // dừng ở đây
        }
        ...
        btnPlace.addEventListener("click", function () {
          alert(
            "Đặt hàng thành công (demo). Bạn có thể chuyển sang order_success.php"
          );
